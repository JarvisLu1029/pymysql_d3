...
- 帕瓦、波奇塔、彭德與淀治都曾在案發區間成功進入 R03，四者起初都有嫌疑；帕瓦在金庫前玩按鈕尤其可疑，但不是最終犯人。
- 淀治、波奇塔、帕瓦與彭德的足跡尺寸皆記錄為 27.5；四者分別帶有深橘帽 T、布質胸背帶、布質腕帶與南瓜圍巾，都可能留下現場纖維，因此第三關仍不能定案。
...
WHERE s.shoe_size = 27.5
  AND s.has_orange_accessory = TRUE
  AND a.room_id = 'R03'
  AND a.action = 'IN'
