...
CREATE TABLE suspects (
    ...
    has_orange_accessory BOOLEAN NOT NULL DEFAULT FALSE,
...
(104, '帕瓦', '血之魔人',           27.5, '9920', TRUE,  '表示戴著橘色布質腕帶，只在金庫前玩過按鈕'),
(105, '波奇塔', '鏈鋸惡魔',         27.5, '5537', TRUE,  '表示穿著橘色布質胸背帶，在地下室檢查配電箱'),
...
('CAM-C3', 105, '2026-08-20 21:13:34', '黃金吐司保管庫', '橘色布質胸背帶', '橡膠球', 0.93),
...
('2026-08-20 21:26:35', '黃金吐司保管庫', '纖維', '橘色纖維，可能來自深橘帽 T、布質胸背帶、布質腕帶或南瓜圍巾'),
