...
(suspect_id, name, job_title, is_humanoid, shoe_size, phone_last4, has_orange_trace, interview_note) VALUES
(101, '瑪奇瑪', '公安對魔特異課主管',  TRUE, 24.0, '1842', FALSE, '表示整晚都在貴賓室接待來賓'),
(102, '淀治', '公安惡魔獵人',        TRUE, 27.5, '7319', TRUE,  '表示 21:00 後都在一樓尋找帕瓦，深橘色連帽外套留在休息室'),
(103, '早川秋', '公安惡魔獵人',      TRUE, 26.5, '4061', FALSE, '表示 20:20 奉命巡檢 R03，離開後一直在修復室檢查展示架'),
(104, '帕瓦', '血之魔人',            TRUE, 23.5, '9920', TRUE,  '表示戴著橘色布質腕帶，只在金庫前玩過按鈕'),
(105, '波奇塔', '鏈鋸惡魔',         FALSE, 12.0, '5537', TRUE,  '表示自己本來就是橘色，在地下室檢查配電箱'),
(106, '洛伊德', '西國情報員',        TRUE, 24.5, '2684', FALSE, '表示 20:32 帶展品清冊進入 R03 核對封條，之後回辦公室整理任務清單'),
(107, '約兒', '市政府職員',          TRUE, 26.0, '1158', FALSE, '表示整晚待在貴賓室'),
(108, '安妮雅', '伊甸學園學生',      TRUE, 23.0, '6421', FALSE, '表示打烊後在咖啡廳等待家人'),
(109, '彭德', '安妮雅的狗',         FALSE, 27.5, '8873', TRUE,  '表示戴著橘色南瓜圖案圍巾在二樓跟著吐司香味散步'),
(110, '達米安·戴斯蒙德', '伊甸學園學生', TRUE, 27.0, '3095', FALSE, '表示在資料室歸還文件'),
(111, '蕾潔', '咖啡店工讀生',        TRUE, 24.0, '2468', FALSE, '表示 20:44 受託將飲品送進 R03，三分鐘後就離開'),
(112, '蝙蝠惡魔', '惡魔觀察對象',   FALSE, 31.5, '1357', FALSE, '表示 20:52 在公安陪同下進入 R03 接受識別測試，兩分鐘後離開');
...
(111, 'R01', 'IN',  '2026-08-20 19:36:24', 'SUCCESS'),
(112, 'R06', 'IN',  '2026-08-20 19:50:16', 'SUCCESS'),
...
(111, 'R03', 'IN',  '2026-08-20 20:46:12', 'SUCCESS'),
(111, 'R03', 'OUT', '2026-08-20 20:49:08', 'SUCCESS'),
(106, 'R05', 'IN',  '2026-08-20 20:51:44', 'SUCCESS'),
(112, 'R03', 'IN',  '2026-08-20 20:52:23', 'SUCCESS'),
(112, 'R03', 'OUT', '2026-08-20 20:54:31', 'SUCCESS'),
...
('CAM-C3', 111, '2026-08-20 20:46:35', '黃金吐司保管庫', '白色襯衫', '飲品托盤', 0.96),
('CAM-C3', 112, '2026-08-20 20:52:48', '黃金吐司保管庫', '深灰色皮膜', '識別測試牌', 0.92),
...
(111, 106, '2026-08-20 20:18:44', 'R03 的飲品外送已核准，我會刷自己的識別證進入。', FALSE),
(101, 112, '2026-08-20 20:19:30', '今晚的非人型門禁識別測試維持原時段。', FALSE),
...
('2026-08-20 21:26:10', '黃金吐司保管庫', '足跡', '人型鞋印尺寸介於 23.0 至 28.0；非人型足跡尺寸介於 10.0 至 28.0，現場共有四組符合橘色痕跡的足跡'),
...
SELECT
    ...
    'R03' AS crime_room,
    '先找出當晚進入 R03 的八名訪客，再依人型與非人型足跡區間鎖定嫌疑人' AS mission;
