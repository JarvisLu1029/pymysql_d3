...
(101, '陳雅婷', '館長',       24.0, '1842', FALSE, '表示整晚都在貴賓室接待贊助人'),
(102, '林冠宇', '保全主管',   27.5, '7319', TRUE,  '表示 21:00 後都在一樓巡邏'),
(103, '王志明', '修復師',     26.5, '4061', FALSE, '表示在修復室處理畫框'),
(104, '李佩珊', '記者',       23.5, '9920', TRUE,  '表示 21:10 已離開博物館'),
(105, '張博翔', '電機技師',   28.0, '5537', FALSE, '表示在地下室檢查配電箱'),
(106, '吳佳蓉', '策展助理',   24.5, '2684', FALSE, '表示在辦公室整理清單'),
(107, '趙偉倫', '收藏家',     27.5, '1158', TRUE,  '表示整晚待在貴賓室'),
(108, '周欣怡', '咖啡廳店員', 23.0, '6421', FALSE, '表示打烊後在咖啡廳盤點'),
(109, '黃俊傑', '清潔人員',   26.0, '8873', TRUE,  '表示在二樓清潔洗手間'),
(110, '許文豪', '實習生',     27.0, '3095', FALSE, '表示在資料室歸還文件');
...
(107, 101, '2026-08-20 20:10:13', '今晚我想再看一次藍寶石。', FALSE),
...
(102, 108, '2026-08-20 21:02:33', '剛才買的保溫袋先別登記到盤點表。', TRUE),
...
('2026-08-20 21:26:10', '藍寶石展品庫', '鞋印', '鞋底長度推估為 27.5 號'),
('2026-08-20 21:26:35', '藍寶石展品庫', '纖維', '深藍色外套纖維'),
('2026-08-20 21:27:11', '藍寶石展品庫', '系統紀錄', '21:11:50 至 21:20:10 監視器訊號中斷'),
('2026-08-20 21:34:28', '員工停車場', '包裝碎片', '銀色保溫袋內襯，帶有展品櫃玻璃粉末');

-- 給學生的第一張「案情卡」可從這個 View 讀取，不直接揭露嫌犯姓名。
CREATE VIEW case_brief AS
SELECT
    '午夜藍寶石失竊案' AS case_name,
